...
public:
	...
	Status GetLast (RecordID& rid, char* key, PageID & pageNo);
	...
	Status FindPage(const char *key, PageID& pageNo, bool& leftMost);
	Status FindKeyWithPage(PageID pageNo, char *key, bool& leftMost);
